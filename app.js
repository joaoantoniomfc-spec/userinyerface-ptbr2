...
module.exports = "<div class=cookies><div class=\"align align--fluid\"><div class=align__cell><p class=cookies__message>Este site usa cookies. Você concorda com isso?</p></div><div class=align__cell><div class=\"align align--gutter-md u-right\"><div class=align__cell><ui-button @click=hide color=transparent>Aceitar</ui-button></div><div class=align__cell><ui-button class=cookies__button color=white>Recusar</ui-button></div></div></div></div></div>";
...
module.exports = "<div class=end-screen><h1 class=end-screen__title>Você mandou muito bem!</h1><h2 class=end-screen__subtitle>Um verdadeiro mestre de interfaces.</h2><img class=end-screen__image src=/images/carlton-dancing.gif alt=\"Carlton Dancing\"></div>";
