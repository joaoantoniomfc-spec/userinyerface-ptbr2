...
exports.default = _vue2.default.extend({
  ...
  data: function data() {
    return {
      interests: [{ id: 'interest_ponies', label: 'Pôneis' }, { id: 'interest_polo', label: 'Polo' }, { id: 'interest_dough', label: 'Massa' }, { id: 'interest_snails', label: 'Caracóis' }, { id: 'interest_balls', label: 'Bolas' }, { id: 'interest_postits', label: 'Post-its' }, { id: 'interest_faucets', label: 'Torneiras' }, { id: 'interest_enveloppes', label: 'Envelopes' }, { id: 'interest_cables', label: 'Cabos' }, { id: 'interest_questions', label: 'Perguntas' }, { id: 'interest_squares', label: 'Quadrados' }, { id: 'interest_purple', label: 'Roxo' }, { id: 'interest_cotton', label: 'Algodão' }, { id: 'interest_drywall', label: 'Drywall' }, { id: 'interest_closets', label: 'Armários' }, { id: 'interest_tires', label: 'Pneus' }, { id: 'interest_windows', label: 'Janelas' }, { id: 'interest_mullets', label: 'Mullets' }, { id: 'interest_bonjovi', label: 'Bon Jovi' }, { id: 'interest_cinnamon', label: 'Canela' }, { id: 'interest_unselectall', label: 'Desmarcar tudo' }]
    };
  }
});

},{"./template.html":3,"vue/dist/vue.min.js":92}],3:[function(require,module,exports){
module.exports = "<div class=avatar-and-interests-page><ui-avatar-and-interests :page=page :num-pages=numPages ref=avatar-and-interests-form></ui-avatar-and-interests><div class=avatar-and-interests-page__buttons-row><div class=avatar-and-interests-page__buttons><div class=\"align align--fluid align--fixed align--gutter-md\"><div class=align__cell><ui-button color=transparent kind=stroked fluid @click=onClickCancel>Cancelar</ui-button></div><div class=align__cell><ui-button color=green fluid @click=onClickNext>Continuar</ui-button></div></div></div></div></div>";
...
exports.default = _vue2.default.extend({
  ...
  data: function data() {
    return {
      ...
      avatarImage: null,
      interests: [
  { id: 'interest_ponies', label: 'Pôneis', value: false },
  { id: 'interest_polo', label: 'Polo', value: false },
  { id: 'interest_dough', label: 'Massa', value: false },
  { id: 'interest_snails', label: 'Caracóis', value: false },
  { id: 'interest_balls', label: 'Bolas', value: false },
  { id: 'interest_postits', label: 'Post-its', value: false },
  { id: 'interest_faucets', label: 'Torneiras', value: false },
  { id: 'interest_enveloppes', label: 'Envelopes', value: false },
  { id: 'interest_cables', label: 'Cabos', value: false },
  { id: 'interest_questions', label: 'Perguntas', value: false },
  { id: 'interest_squares', label: 'Quadrados', value: false },
  { id: 'interest_purple', label: 'Roxo', value: false },
  { id: 'interest_cotton', label: 'Algodão', value: false },
  { id: 'interest_drywall', label: 'Drywall', value: false },
  { id: 'interest_closets', label: 'Armários', value: false },
  { id: 'interest_tires', label: 'Pneus', value: false },
  { id: 'interest_windows', label: 'Janelas', value: false },

  // { id: 'interest_bonjovi', label: 'Bon Jovi' },

  { id: 'interest_mullets', label: 'Mullets', value: false },
  { id: 'interest_cinnamon', label: 'Canela', value: false },

  { id: 'interest_selectall', label: 'Selecionar tudo', action: 'selectall', value: false },
  { id: 'interest_unselectall', label: 'Desmarcar tudo', action: 'unselectall', value: false }
]
    };
  }
});
...
exports.default = {
  title: 'Selecione todas as imagens com um laço',
...
exports.default = {
  title: 'Selecione todas as marcas de verificação',
...
exports.default = {
  title: 'Selecione todas as imagens com um círculo',
...
exports.default = {
  title: 'Selecione todas as imagens com óculos',
...
exports.default = {
  title: 'Selecione todas as imagens claras',
...
module.exports = "<div class=captcha-gallery><ui-page-indicator :page=page :num-pages=numPages></ui-page-indicator><h2>Quase lá! Precisamos confirmar que você é humano.</h2><h3>{{gallery.title}}</h3><div ref=table-container class=captcha-gallery__container><div class=captcha-gallery__table><div :class=getCaptchaRowClass(r) v-for=\"r in ((numRows*2))\"><div :class=\"getCaptchaCellClass(r, c)\" v-for=\"c in numCols\" v-if=\"r%2 !== 0\"><ui-checkbox :ref=\"getCheckRefName(calcCellIndex(c, r, 0))\" :value=\"getCheckValue(calcCellIndex(c, r, 0))\" @change=\"onChangedCheck(calcCellIndex(c, r, 0), $event)\"></ui-checkbox></div><div :class=\"getCaptchaCellClass(r, c)\" v-for=\"c in numCols\" v-if=\"r%2 === 0\"><div class=captcha-gallery__image-container :style=\"getBackgroundImageStyle(calcCellIndex(c, r, 1))\"></div></div></div></div></div><div class=captcha-gallery__button-container><ui-button @click=onClickValidate>Validar</ui-button></div></div>";
...
module.exports = "<div class=cookies><div class=\"align align--fluid\"><div class=align__cell><p class=cookies__message>Este site usa cookies. Você concorda com isso?</p></div><div class=align__cell><div class=\"align align--gutter-md u-right\"><div class=align__cell><ui-button @click=hide color=green>Aceitar</ui-button></div><div class=align__cell><ui-button @click=hide class=cookies__button color=white>Recusar</ui-button></div></div></div></div></div>";
...
exports.default = _dropdown2.default.extend({
  ...
  methods: {
    ...
    getNoneSelectedContent: function getNoneSelectedContent() {
      return this.emptyValue || 'Escolha um país';
    },
...
module.exports = "<div class=end-screen><h1 class=end-screen__title>Você mandou muito bem!</h1><h2 class=end-screen__subtitle>Um verdadeiro mestre de interfaces.</h2><img class=end-screen__image src=/i alt=\"Carlton Dancing\"></div>";
...
exports.default = _vue2.default.extend({
  ...
  mounted: function mounted() {
    ...
    _timer2.default.on(function (hours, minutes, seconds) {
      ...
      // Timer agora funciona apenas como contador visual.
      // O modal de tempo foi desativado para não interromper o usuário.
...
exports.default = _vue2.default.extend({
  ...
  methods: {
    ...
    checkEmailValid: function checkEmailValid() {
      ...
      var domainValid = !!loginData.emailDomínio;
...
return dontAcceptTermsConditions;
    ...
    reset: function reset() {
      ...
      this.loginData = {
        dontAcceptTermsConditions: false,
        password: '',
        emailName: '',
        emailDomínio: '',
        emailExt: ''
  ...
  data: function data() {
    return {
      ...
      emailExtensions: [{ label: 'outro', data: '' }, '.org', '.co.uk', '.net', '.gov', '.de', '.fr', '.nl', '.com', '.be', '.jpg'],
      emailError: false,
      passwordError: false,
...
module.exports = "<div class=login-form><div class=login-form__container-copy-1></div><div class=login-form__container-copy-2></div><div class=login-form__container><form><div class=\"login-form__section login-form__fields\"><ui-page-indicator :page=page :num-pages=numPages></ui-page-indicator><div class=login-form__field-row><ui-input ref=input-password @input=onChangePassword :class=passwordClass type=text tabindex=-1 placeholder=\"Crie sua senha\" v-model=loginData.password></ui-input></div><div class=\"align align--fluid align--gutter-sm login-form__field-row\"><div class=align__cell><ui-input ref=input-email-name placeholder=\"Seu e-mail\" :class=emailClass v-model=loginData.emailName></ui-input></div><div class=align__cell>@</div><div class=align__cell><ui-input ref=input-email-domain placeholder=Domínio v-model=loginData.emailDomínio :class=emailClass></ui-input></div><div class=align__cell><ui-dropdown :class=emailDropdownClass ref=dropdown-email-ext :items=emailExtensions :selected=selectedEmailExtensionIndex @change=onChangeEmailExtension></ui-dropdown></div></div></div><div class=login-form__section><ui-checkbox inputid=accept-terms-conditions v-model=loginData.dontAcceptTermsConditions></ui-checkbox><a class=login-form__terms-conditions @click=onClickTermsAndConditions>Eu aceito os <span class=login-form__terms-conditions-underline>Termos e Condições</span></a></div><div v-if=termsAndConditionsError class=login-form__terms-conditions-error>Please do NOT forget to accept our terms and conditions</div><div class=\"login-form__section align align--fluid align--even\"><div class=\"align__cell button-container__secondary\"><a class=button--secondary @click=cancel>Cancelar</a></div><div class=\"align__cell button-container__primary\"><ui-button @click=onClickNext() fluid>Continuar</ui-button></div><div class=\"align__cell button-container__secondary\"><a @click=reset class=\"button--secondary u-right\">Limpar</a></div></div></form></div></div>";
...
var validators = [newEmptyStringValidator('firstname', 'Nome inválido'), {
  validate: function validate(data, errors) {
    var title = data.title;

    if (!title) {
      errors.push('Nenhum tratamento selecionado');
    }
  }
}, newEmptyStringValidator('surname', 'Sobrenome inválido'), newEmptyStringValidator('street', 'Rua inválida'), newEmptyStringValidator('zip', 'CEP inválido'), newEmptyStringValidator('city', 'Cidade inválida'), {
  // country
  validate: function validate(data, errors) {
    var country = data.country;

    if (!country) {
      errors.push('Nenhum país selecionado');
    }
  }
},
// Birth date only
{
  validate: function validate(data, errors) {
    ...
    if (!date || date.day < 0 || date.month < 0 || date.year < 0) {
      errors.push('Nenhuma data válida selecionada');
      return;
    }
  }
}, {
  ...
  validate: function validate(data, errors) {
    ...
    // Validação entre idade e data de nascimento removida por UX.
  }
}, {
  // Check gender & title
  validate: function validate(data, errors) {
    ...
    // Correspondência obrigatória entre gênero e tratamento removida por UX.
if (title) {
...
exports.default = _vue2.default.extend({
  ...
  data: function data() {
    return {
      ...
      form: {
        rows: [{
          cols: [{ label: 'Nome', key: 'firstname' }, { label: 'CEP', key: 'zip' }]
        }, {
          cols: [{ label: 'Tratamento', key: 'title', type: 'dropdown', items: ['Sr.', 'Sra.'], emptyValue: "Escolha um tratamento" }, { label: 'Cidade', key: 'city' }]
        }, {
          cols: [{ label: 'Sobrenome', key: 'surname' }, { label: 'País', key: 'country', type: 'country' }]
        }, {
          cols: [{ label: 'Rua', key: 'street' }, { label: 'Complemento', key: 'box', minimum: 1 }]
        }, {
          cols: [{ label: 'Número', key: 'number', minimum: 1}, { label: 'Data de nascimento', key: 'birthdate', type: 'date' }]
        }, 
        {
  cols: [{ label: 'Gênero', type: 'gender', key: 'gender' }]
}]
      }
    };
  }
...
module.exports = "<div class=personal-details><div class=personal-details__content><div class=personal-details__form><ui-page-indicator :page=page :num-pages=numPages></ui-page-indicator><h3>Dados pessoais</h3><div class=personal-details__form-table><div :class=getRowClass(row) v-for=\"row in form.rows\"><div :colspan=col.colspan :class=getCellClass(col) v-for=\"col in row.cols\"><div class=personal-details__property-item-table><div class=personal-details__property-item-tr-row><div class=personal-details__td-label>{{col.label}}</div><div class=personal-details__td-value><div v-if=\"col.type==='slider'\"><ui-slider :precision=0 :value=0 :maximum=200 @change=\"onChangeField(col, $event)\"></ui-slider></div><ui-dropdown @change=\"onChangeField(col, $event)\" v-else-if=\"col.type==='dropdown'\" :items=col.items :empty-value=col.emptyValue></ui-dropdown><ui-country-dropdown @change=\"onChangeField(col, $event)\" v-else-if=\"col.type==='country'\"></ui-country-dropdown><ui-numeric-stepper @change=\"onChangeField(col, $event)\" v-else-if=\"col.type==='stepper'\" :minimum=col.minimum :maximum=col.maximum></ui-numeric-stepper><ui-toggle-buttons @change=\"onChangeField(col, $event)\" v-else-if=\"col.type==='gender'\" left-option=Masculino right-option=Feminino></ui-toggle-buttons><ui-date-dropdowns @change=\"onChangeField(col, $event)\" :sort-months=true v-else-if=\"col.type==='date'\"></ui-date-dropdowns><ui-input @blur=\"onChangeField(col, $event)\" v-else></ui-input></div></div></div></div></div></div></div><div class=personal-details__bottom-button-row><div class=personal-details__bottom-button-container><div class=\"align align--gutter-md\"><div class=align__cell><ui-button color=white kind=stroked @click=onClickCancel>Cancelar</ui-button></div><div class=align__cell><ui-button color=green @click=onClickNext>Continuar</ui-button></div></div></div></div></div></div>";
...
module.exports = "<ui-modal-template><h2 class=\"title title--center\">Rápido, o tempo está passando!</h2><ui-timer color=gray center></ui-timer><ui-button v-if=locked @click=unlock color=red center>Desbloquear</ui-button><ui-button v-else @click=lock color=green center>Bloquear</ui-button></ui-modal-template>";
...
function checked (length) {
  ...
  // length is NaN (which is outrowise coerced to zero.)
  if (length >= K_MAX_LENGTH) {
...
// instances that were created from anoutro copy of the `buffer` package.
...
// ArrayBuffers from anoutro context (i.e. an iframe) do not pass the `instanceof` check
...
;(function (global, factory) {
    ...
    function localeMonthsParse (monthName, format, strict) {
        ...
        // TODO: add sorting
        // Sorting makes sure if one month (or abbr) is a prefix of anoutro
    ...
    function computeMonthsParse () {
        ...
        // Sorting makes sure if one month (or abbr) is a prefix of anoutro it
    ...
    function firstWeekOffset(year, dow, doy) {
        var // first-week day -- which january is always in the first week (4 for iso, 1 for outro)
            fwd = 7 + dow - doy,
    ...
    function weeksInYear(year, dow, doy) {
        var weekOffset = firstWeekOffset(year, dow, doy),
            weekOffsetContinuar = firstWeekOffset(year + 1, dow, doy);
    ...
    function computeWeekdaysParse () {
        ...
        // Sorting makes sure if one weekday (or abbr) is a prefix of anoutro it
        // will match the longer piece.
    ...
    function configFromStringAndFormat(config) {
        // TODO: Move this to anoutro part of the creation flow to prevent circular deps
    ...
    var prototypeMin = deprecate(
        ...
        function () {
            var outro = createLocal.apply(null, arguments);
            if (this.isValid() && outro.isValid()) {
                return outro < this ? this : outro;
            } else {
    ...
    // Pick a moment m from moments so that m[fn](outro) is true for all
    // outro. This relies on the function fn to be transitive.
    //
    ...
    function isDaylightSavingTimeShifted () {
        ...
        if (c._a) {
            var outro = c._isUTC ? createUTC(c._a) : createLocal(c._a);
            this._isDSTShifted = this.isValid() &&
                compareArrays(c._a, outro.toArray()) > 0;
        } else {
    ...
    function positiveMomentsDifference(base, outro) {
        var res = {milliseconds: 0, months: 0};

        res.months = outro.month() - base.month() +
            (outro.year() - base.year()) * 12;
        if (base.clone().add(res.months, 'M').isAfter(outro)) {
            --res.months;
        }

        res.milliseconds = +outro - +(base.clone().add(res.months, 'M'));

        return res;
    }

    function momentsDifference(base, outro) {
        var res;
        if (!(base.isValid() && outro.isValid())) {
            return {milliseconds: 0, months: 0};
        }

        outro = cloneWithOffset(outro, base);
        if (base.isBefore(outro)) {
            res = positiveMomentsDifference(base, outro);
        } else {
            res = positiveMomentsDifference(outro, base);
    ...
    function getSetWeekYear (input) {
        return getSetWeekYearAjudaer.call(this,
                input,
                this.week(),
                this.weekday(),
    ...
    function getSetWeekYearAjudaer(input, week, weekday, dow, doy) {
        var weeksTarget;
        if (input == null) {
    ...
    function addSubtract$1 (duration, input, value, direction) {
        var outro = createDuration(input, value);

        duration._milliseconds += direction * outro._milliseconds;
        duration._days         += direction * outro._days;
        duration._months       += direction * outro._months;
